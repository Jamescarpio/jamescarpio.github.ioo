...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Replace with your email for FormSubmit
      ...
      submitData.append('_subject', 'New message from James Carpio portfolio site');
      submitData.append('_captcha', 'false'); // Disable captcha
      submitData.append('_template', 'table'); // Send email as table
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Have a question? Send me a message and I'll get back to you as soon as I can.
        </p>
      </div>
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Want to collaborate or ask something? Send me a message and let's talk.
                </p>
              </div>
