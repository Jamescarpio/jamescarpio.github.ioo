...
const WORDS = ["BS Mechanical Engineering Student", "Engineering • AI • Web"];
const TECH_STACK = ["HTML", "CSS", "JavaScript", "React", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/YOUR_USERNAME" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/YOUR_LINKEDIN" },
  { icon: Instagram, link: "https://www.instagram.com/YOUR_INSTAGRAM" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  I build clean, future-ready projects—combining engineering thinking, modern UI, and practical AI tools.
                </p>
