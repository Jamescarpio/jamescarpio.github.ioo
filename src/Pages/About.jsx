        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             I'm a BS Mechanical Engineering student based in the Philippines, interested in applied AI, systems thinking, and building useful web tools that communicate clearly.            </p>
